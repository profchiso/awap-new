...
//           <button
//             onClick={() => props.handleOpen()}
//             className="text-white absolute right-16 top-1/3  bg-primary px-12 font-body shadow-primary px-5 py-2 rounded-md focus:outline-none text-sm lg:text-md font-medium"
//           >
//             FINISH
//           </button>
//         ) : (
