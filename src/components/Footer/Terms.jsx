    ...
    <div className="max-w-screen-2xl mx-auto px-6 lg:px-16">
      ...
      <div className="text-base  max-w-3xl mx-auto font-medium leading-7">
        <div className="opacity-75 ">
          <div className="">Welcome to the Awesumedge's Terms of Service.</div>
          <br />
          <div>
            Please read the following terms of service agreement carefully. by
            accessing or using our website (the "site") or our services, you
            hereby agree to be bound by these terms and conditions and all terms
            incorporated herein by reference. it is the responsibility of you,
            the user, customer, or prospective customer to read the terms and
            conditions before proceeding to use this site. if you do not
            expressly agree to all of the terms and conditions, then please do
            not access or use our site or our services.
          </div>
          <br />
          <div>
            The present terms and conditions (this <b>"Agreement" </b> or{" "}
            <b> "Terms" </b> ) is a legal agreement between you and AwesumEdge
            LLC (hereinafter <b>" AwesumEdge"</b> ), a company duly organized
            and validly existing, located at PO Box 243, Beaverton, Oregon
            97075. This Agreement annuls and voids all previous agreements.
          </div>
          <br />
        </div>
        <br />
        ...
        <div>
          <div className="text-primary text-xl">OVERVIEW</div>
          <br />
          <div className="opacity-75 ">
            <div>
              The Site{" "}
              ...
              is operated by AwesumEdge. Throughout the Site, the terms "we",
              "us" and "our" refer to AwesumEdge. AwesumEdge offers this Site,
            ...
            <div>
              ...
              these Terms are considered an offer, acceptance is expressly
              limited to these Terms.
            </div>
            <br />
            <div>
              Any new features or tools which are added to the current store
              shall also be subject to the Terms. You can review the most
              current version of the Terms at any time on this page. We reserve
              the right to update, change or replace any part of these Terms by
        ...
        <div>
          <div className="text-primary text-xl">SECTION 1 - GENERAL TERMS</div>
          <br />
          <div className="opacity-75 ">
            <div>
            ...
            <br />
            <div>
              You may not use our products or Site for any illegal or
              unauthorized purpose nor may you, in the use of our products or
              Site, violate any laws in your jurisdiction (including but not
              limited to motor vehicle laws).
            </div>
            <div>
            ...
            <div>
              ...
              immediate termination of your account and right to use our
              Service.
            </div>
            <br />
            <div>
            ...
            <div className="ml-5">
              <ol class="list-decimal pt-2 list-outside">
                ...
                <li className="pl-2">
                  Change, suspend or discontinue all or any part of our products
                  or Site.
                </li>
                <li className="pl-2">
                  Refuse, move, or remove any content that is available on all
                  or any part of our Site.
                </li>
                <li className="pl-2">Deactivate or delete your accounts.</li>
                <li className="pl-2">
            ...
            <br />
            <div>
              You understand and agree that our Site may include communications
              such as service announcements and administrative or legal notices
              from us. Please note that you cannot opt out of receiving these
              notices.
            </div>
            <br />
            <div>
            ...
            <div>
              ...
              exploit any portion of the Site, use of the Site, or access to the
              Site or any contact on the Site, without express written
              permission by us.
            </div>
            <br />
            <div>
              You may not modify, publish, transmit, reverse engineer,
              ...
              on the Site. AwesumEdge content is not for resale. Use of the Site
              does not entitle users to make any unauthorized use of any
              ...
              permission of AwesumEdge and the copyright owner. You agree that
              ...
              intellectual property of AwesumEdge or our licensors except as
        ...
        <div>
          ...
          <div className="opacity-75 ">
            <div>
              ...
              AwesumEdge Site. The terms "member," "membership," and "account"
              all refer to this registration as a member on AwesumEdge's Site.
              If you are merely surfing or browsing through the Site and have
              not yet created an account, your use of the Site is still subject
              to this Agreement; if you do not agree to this Agreement, do not
              use the Site.
            </div>
            <br />
            <div>
              When you create an account, you will provide a first name, last
              name and unique email. We will also ask you to create a password.
              Because any activities that occur under your email or password are
              your responsibility it is important for you to keep your email
              and/or password secure. You may not assign or otherwise transfer
              your account to any other person or entity. You acknowledge that
              AwesumEdge is not responsible for third party access to your
              account that results from theft or misappropriation of your
              account. Notify us immediately if you believe that someone has
              used your email, or password without your authorization.
            </div>
            <br />
            <div>
            ...
            <div className="">
              <ol class="list-lowerAlpha pt-2 list-outside  flex flex-col gap-5 ml-5">
                ...
                <li className="pl-2">
                  ...
                  information in an effort to maintain accuracy and completeness
                  at all times.
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              inaccurate or incomplete nature, AwesumEdge LLC will have
              sufficient grounds and rights to suspend or terminate the member
              in violation of this aspect of the Agreement, and as such refuse
              any and all current or future use of AwesumEdge LLC Services, or
              any portion thereof.
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="text-primary text-xl">SECTION 3 - CONDUCT</div>
          <br />
          <div className="opacity-75 ">
            <div>
              As a user or member of the Site, you herein acknowledge,
              understand and agree that all information, text, software, data,
              photographs, music, video, messages, tags or any other content,
              whether it is publicly or privately posted and/or transmitted, is
              the expressed sole responsibility of the individual from whom the
              content originated. In short, this means that you are solely
              responsible for any and all content posted, uploaded, emailed,
              transmitted or otherwise made available by way of the AwesumEdge
              Services, and as such, we do not guarantee the accuracy, integrity
              or quality of such content. It is expressly understood that by use
              of our Services, you may be exposed to content including, but not
              limited to, any errors or omissions in any content posted, and/or
              ...
              available by AwesumEdge.
            </div>
            <br />
            <div>
              Furthermore, you herein agree not to make use of AwesumEdge LLC's
            ...
            <div className="">
              <ol class="list-lowerAlpha pt-2 list-outside  flex flex-col gap-5 ml-5">
                ...
                <li className="pl-2">
                  ...
                  limited to, any AwesumEdge officials, forum leaders, guides or
                  hosts or falsely stating or otherwise misrepresenting any
                  affiliation with an individual or entity;
                </li>
                <li className="pl-2">
                  forging captions, headings or titles or otherwise offering any
                  content that you personally have no right to pursuant to any
                  law nor having any contractual or fiduciary relationship with;
                </li>
                <li className="pl-2">
                  uploading, posting, emailing, transmitting or otherwise
                  offering any such content that may infringe upon any patent,
                  copyright, trademark, or any other proprietary or intellectual
                  rights of any other party;
                </li>
                <li className="pl-2">
                  uploading, posting, emailing, transmitting or otherwise
                  offering any content that you do not personally have any right
                  to offer pursuant to any law or in accordance with any
                ...
                <li className="pl-2">
                  ...
                  solicitation, except in any such areas that may have been
                  designated for such purpose;
                </li>
                <li className="pl-2">
                  uploading, posting, emailing, transmitting, or otherwise
                  offering any source that may contain a software virus or other
                  computer code, any files and/or programs which have been
                  designed to interfere, destroy and/or limit the operation of
                  any computer software, hardware, or telecommunication
                  equipment;
                </li>
                <li className="pl-2">
                  disrupting the normal flow of communication, or otherwise
                  acting in any manner that would negatively affect other users'
                  ability to participate in any real time interactions;
                </li>
                <li className="pl-2">
                  interfering with or disrupting any AwesumEdge LLC Services,
                  servers and/or networks that may be connected or related to
                  our website, including, but not limited to, the use of any
                  device software and/or routine to bypass the robot exclusion
                  headers;
                </li>
                <li className="pl-2">
                  ...
                  would include without limitation, the New York Stock Exchange,
                  the American Stock Exchange, or the NASDAQ, and any
                  regulations having the force of law;
                </li>
                <li className="pl-2">
                  providing informational support or resources, concealing
                  and/or disguising the character, location, and or source to
                  any organization delegated by the United States government as
                  a "foreign terrorist organization" in accordance to Section
                ...
                <li className="pl-2">
                  ...
                  other member or user in connection with the prohibited conduct
                  and/or activities which have been set forth in the
            ...
            <br />
            <div>
              AwesumEdge LLC herein reserves the right to pre-screen, refuse
              and/or delete any content currently available through our
              Services. In addition, we reserve the right to remove and/or
              delete any such content that would violate the Terms or which
              would otherwise be considered offensive to other visitors, users
              and/or members.
            </div>
            <br />
            <div>
              AwesumEdge LLC herein reserves the right to access, preserve
              and/or disclose member account information and/or content if it is
              requested to do so by law or in good faith belief that any such
              action is deemed reasonably necessary for:
            </div>
            <div>
              <ol class="list-lowerAlpha pt-4 list-outside  flex flex-col gap-5 ml-5">
                <li className="pl-2">compliance with any legal process;</li>
                <li className="pl-2">enforcement of the Terms;</li>
                <li className="pl-2">
                ...
                <li>
                  ...
                  AwesumEdge LLC, its visitors, users and members, including the
                  general public.
                </li>
              </ol>
            </div>
            <br />
            <div>
              AwesumEdge LLC herein reserves the right to include the use of
              security components that may permit digital information or
              material to be protected, and that such use of information and/or
              material is subject to usage guidelines and regulations
              established by AwesumEdge LLC or any other content providers
              supplying content services to AwesumEdge LLC. You are hereby
              prohibited from making any attempt to override or circumvent any
              of the embedded usage rules in our Services. Furthermore,
        ...
        <div>
          ...
          <div className="opacity-75 ">
            <div>
              ...
              to online conduct and that which is considered acceptable content.
              Uploading, posting and/or transferring of software, technology and
              other technical data may be subject to the export and import laws
              of the United States and possibly other countries. Through the use
              of our network, you thus agree to comply with all applicable
              export and import laws, statutes and regulations, including, but
              not limited to, the Export Administration Regulations{" "}
              <a
                target="_blank"
                href="http://www.access.gpo.gov/bis/ear/ear_data.html"
                className="text-primary hover:text-primary hover:underline"
              >
              ...
              <a
                target="_blank"
                href="http://www.treasury.gov/resource-center/sanctions/Programs/Pages/Programs.aspx"
                className="text-primary hover:text-primary hover:underline"
              >
            ...
            <br />
            <ol class="list-lowerAlpha pt-2 list-outside ml-5 flex flex-col gap-5">
              <li className="pl-2">
                are not on the list of prohibited individuals which may be
                identified on any government export exclusion report{" "}
                <a
                  target="_blank"
                  href="http://www.bis.doc.gov/complianceandenforcement/liststocheck.htm"
                  className="text-primary hover:text-primary hover:underline"
                >
              ...
              <li className="pl-2">
                agree not to post, transfer nor upload any software, technology
                or any other technical data which would be in violation of the
        ...
        <div>
          ...
          <div className="opacity-75 ">
            <div>
              AwesumEdge LLC shall not lay claim to ownership of any content
              submitted by any visitor, member, or user, nor make such content
              available for inclusion on our website Services. Therefore, you
              hereby grant and allow for AwesumEdge LLC the below listed
            ...
            <ol class="list-lowerAlpha pt-2 list-outside ml-5 flex flex-col gap-5">
              <li className="pl-2">
                ...
                publicly accessible areas of AwesumEdge LLC's Sites, the license
                ...
                available so long as you are a member of AwesumEdge LLC's sites,
                and shall terminate at such time when you elect to discontinue
                your membership.
              </li>
              <li className="pl-2">
                Photos, audio, video and/or graphics submitted or made available
                for inclusion on the publicly accessible areas of AwesumEdge
                LLC's sites, the license provided to permit to use, distribute,
                reproduce, modify, adapt, publicly perform and/or publicly
                display said Content on our network Services are for the sole
                purpose of providing and promoting the specific area in which
                this content was placed and/or made available for viewing. This
                license shall be available so long as you are a member of
                AwesumEdge LLC's sites and shall terminate at such time when you
                elect to discontinue your membership.
              </li>
              <li className="pl-2">
                For any other content submitted or made available for inclusion
                on the publicly accessible areas of AwesumEdge LLC's sites, the
                continuous, binding and completely sub-licensable license which
                is meant to permit to use, distribute, reproduce, modify, adapt,
                publish, translate, publicly perform and/or publicly display
                said content, whether in whole or in part, and the incorporation
            ...
            <div>
              ...
              AwesumEdge LLC's Sites are those such areas of our network
              ...
              available to both users and members. However, those areas which
              are not open to the public, and thus available to members only,
            ...
            <div>
              ...
              <div className="pt-3">
                AwesumEdge LLC may provide an area for our user and members to
                contribute feedback to our website. When you submit ideas,
                documents, suggestions and/or proposals ("Contributions") to our
              ...
              <ol class="list-lowerAlpha pt-2 list-outside ml-5 flex flex-col gap-5">
                ...
                <li className="pl-2">
                  AwesumEdge shall not be liable or under any obligation to
                  ensure or maintain confidentiality, expressed or implied,
                  related to any Contributions;{" "}
                </li>
                <li className="pl-2">
                  AwesumEdge shall be entitled to make use of and/or disclose
                ...
                <li className="pl-2">
                  ...
                  sole property of AwesumEdge; and
                </li>
                <li className="pl-2">
                  AwesumEdge is under no obligation to either compensate or
        ...
        <div>
          <div className="text-primary text-xl">SECTION 6 - INDEMNITY</div>
          <br />
          <div className="opacity-75 ">
            <div>
              All users and/or members agree to insure and hold AwesumEdge LLC,
              our subsidiaries, affiliates, agents, employees, officers,
              ...
              of AwesumEdge Services or your connection with these Services,
              your violations of the Terms of Service and/or your violation of
        ...
        <div>
          ...
          <div className="opacity-75 ">
            <div>
              ...
              copy, trade, sell, resell nor exploit for any commercial reason
              any part, use of, or access to AwesumEdge's sites.
            </div>
          </div>
        </div>
        <br />
        ...
        <div>
          <div className="text-primary text-xl">SECTION 8 - MODIFICATIONS</div>
          <br />
          <div className="opacity-75 ">
            <div>
              AwesumEdge LLC reserves the right at any time it may deem fit, to
              modify, alter and or discontinue, whether temporarily or
              permanently, our service, or any part thereof, with or without
              prior notice. In addition, we shall not be held liable to you or
              to any third party for any such alteration, modification,
              suspension and/or discontinuance of our Services, or any part
              thereof.
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="text-primary text-xl">SECTION 9 - TERMINATION</div>
          <br />
          <div className="opacity-75 ">
            <div>
              As a member of{" "}
            ...
            <br />
            <div>
              As a member, you agree that AwesumEdge LLC may, without any prior
              written notice, immediately suspend, terminate, discontinue and/or
              limit your account, any email associated with your account, and
            ...
            <div>
              <ol class="list-lowerAlpha pt-2 list-outside  flex flex-col gap-5 ml-5">
                ...
                <li className="pl-2">any extended periods of inactivity;</li>
                <li className="pl-2">
                ...
                <li className="pl-2">
                  the nonpayment of any associated fees that may be owed by you
                  in connection with your www.awesumedge.com account Services.
                </li>
              </ol>
            </div>
            <br />
